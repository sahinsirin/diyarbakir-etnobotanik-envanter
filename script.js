...
// 1. GENİŞLETİLMİŞ VE FOTOĞRAF DESTEKLİ VERİ SETİ
const plantData = {
    ...
    "features": [
        {
            ...
            "properties": {
                ...
                "img": "https://picsum.photos/id/106/400/250" // Buraya kendi resim yolunuzu yazabilirsiniz örn: "img/kenger.jpg"
            }
        },
        {
            "type": "Feature",
            ...
            "properties": {
                ...
                "img": "https://picsum.photos/id/10/400/250"
            }
        },
        {
            "type": "Feature",
        ...
        },
        {
            ...
            "properties": {
                ...
                "img": "https://picsum.photos/id/22/400/250"
            }
        },
        {
            "type": "Feature",
            ...
            "properties": {
                ...
                "img": "https://picsum.photos/id/33/400/250"
            }
        },
        {
            "type": "Feature",
            ...
            "properties": {
                ...
                "img": "https://picsum.photos/id/44/400/250"
            }
        },
        {
            "type": "Feature",
            ...
            "properties": {
                ...
                "img": "https://picsum.photos/id/55/400/250"
            }
        },
        {
            "type": "Feature",
            ...
            "properties": {
                ...
                "img": "https://picsum.photos/id/66/400/250"
            }
        }
        // Excel'deki diğer türleri buraya aynı formatta eklemeye devam edebilirsiniz.
    ]
};
...
// 3. DETAY GÖSTERME FONKSİYONU (Sağ panel ve Harita Popup)
function showDetails(p) {
    const view = document.getElementById('plant-details-view');
    // Sağ panel içeriği
    view.innerHTML = `
        <div class="plant-details-card">
            <img src="${p.img}" alt="${p.turkce_ad}" style="width:100%; border-radius:8px; margin-bottom:10px;">
...
// Harita üzerine tıklanınca açılacak Popup içeriği
function createPopupContent(p) {
    return `
        <div style="text-align:center">
            <img src="${p.img}" style="width:100px; border-radius:4px;">
...
legend.onAdd = function() {
    ...
    div.innerHTML = `
        <i style="background: #008080"></i> Yemeklik<br>
