    ...
    "features": [
        ...
        // 2. Gulik (Yemeklik)
        {
            ...
            "properties": {
                ...
                "sifa_kullanimi": { "genel_kullanim": "Kökü zehirli olmasına rağmen, halk tıbbında haricen romatizma ağrılarına karşı kullanılır." },
                "fotograflar": [PLACEHOLDER_IMAGE_URL],
...
// =================================================================
// 5. Olay Dinleyicilerini Bağlama
// =================================================================
...
function addLegendToMap() {
    ...
    legend.onAdd = function (map) {
        ...
        const labels = [
            { color: '#008000', label: '🍲 Yemeklik' },
            { color: '#CC0000', label: '⚕️ Şifalı' },
            { color: '#FF8C00', label: '🍎💊 Hem Yemeklik Hem Şifalı' }
        ];

        div.innerHTML = '<h4>Kullanım Amacı</h4>';
...
// =================================================================
// 7. Başlangıç ve CSS Stilleri
// =================================================================

// Sayfa yüklendiğinde haritayı, listeyi ve dinleyicileri başlat
document.addEventListener('DOMContentLoaded', function() {
    ...
    /* ------------------------------------------------ */
    /* ARAMA STİLLERİ (Adım 9 Düzeltmesi) */
    /* ------------------------------------------------ */
    #search-container {
        margin-bottom: 15px;
        padding: 10px 0;
    ...
    /* Filter Butonları Stilleri (Adım 8) */
    #filter-buttons {
        margin-bottom: 15px;
        display: flex;
        gap: 10px;
